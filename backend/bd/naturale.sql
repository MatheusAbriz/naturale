...
create table usuario(
    ...
    apelido_usuario varchar(200) null,
...
create table favoritos(
    id_favoritos INT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    id_usuario int not null,
    id_post int not null,
...
create table comentarios(
    ...
    status_comentario BOOLEAN DEFAULT TRUE,
...
DROP CONSTRAINT comentarios_id_usuario_fkey,
ADD CONSTRAINT comentarios_id_usuario_fkey FOREIGN KEY (id_usuario) REFERENCES usuario(id_usuario) ON DELETE CASCADE;
